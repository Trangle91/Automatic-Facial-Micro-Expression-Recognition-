...
def main():
    ...
    for i in range(10):
        ...
        dat = SDI_MER('CASMEII_train_data' , 'data1' )
        dat.process_one_fold()
        
        
        start_epoch,max_epoches,best_acc=0,150,0
        Training_loss=[]
        Validation_loss=[]
        Accuracy = []
        model=VGG_model.vgg19_bn(pretrained=False,num_classes=4)
