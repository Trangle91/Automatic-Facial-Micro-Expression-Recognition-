...
TRAIN_FOLDER = 'Senet_50'
MODEL_FOLDER = './Models/Senet_50'
...
def main():
    ...
    for i in range(10):
        ...
        dat = SDI_MER('CASMEII_train_data' , 'data_senet' )
        dat.process_one_fold()
        
        
        start_epoch,max_epoches,best_acc=0,300,0
        Training_loss=[]
        Validation_loss=[]
        Accuracy = []
        model=Senet50_model.senet50_ferplus_dag()
        ...
        ################################################################################    
        train_data=Database('./data_senet/train/')
        dev_data=Database('./data_senet/validation/')
