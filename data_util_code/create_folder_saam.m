...
% 
FOLDER_MAG_SAAM = '.\\\magnification_code\\OUT_MAG_SAAM\\';
OUT_FOLDER = '.\\OUTFOLD_MAG_SAAM\\';
mkdir(OUT_FOLDER)

list_subject = dir(FOLDER_MAG_SAAM);
...
for i=1:n_subject
    ...
    in_folder_subject = fullfile(FOLDER_MAG_SAAM , curr_name);
